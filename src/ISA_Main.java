...
//            System.out.println(s.toString());
            System.out.format("%-12s%-4s%-5s%-10s%-6s%-4s%-36s%-3s\n",s.getStep(), s.getOpcode(), s.getRegister().getRegAdr(), s.getValue(), s.fiveBitOpcode(), s.getRegister().to3bitAdr(), s.to32bitval(), s.getClkcyc());
        }
        System.out.println("----------------------------------------------------------------------------------------");
        System.out.println("Steps of the Register");
        for(InstructionSet s:steps){
            System.out.format("%s = %d   [%s]\n",s.getRegister().getRegAdr(),s.getValue(),s.to32bitval());
        }
        System.out.println("----------------------------------------------------------------------------------------");
        System.out.println("Values of registers after the execution of the instruction set");
        for(int i =0; i<regs.length;i++){
            System.out.format("%s   %d  [%s]\n",regs[i].getRegAdr(),regs[i].getRegVal(),regs[i].to32bitval());
        }
        System.out.println("----------------------------------------------------------------------------------------");
        int totalClkCycs = 0;
        for(InstructionSet s : steps){
        ...
        double cpi = totalClkCycs/step; // cycle per instruction
        System.out.println(totalClkCycs + " " + step);
